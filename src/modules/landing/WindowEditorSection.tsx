...
const WindowEditorSection = () => (
  <section
    className="components-window-editor relative mx-4 xl:mx-0 flex flex-col lg:flex-row items-center justify-center"
    style={{ paddingBottom: 371 }}
  >
    <div className="relative" style={{ maxWidth: 544, width: '100%' }}>
      ...
      <div
        ...
        className="switch absolute min-w-min hidden sm:block"
      >
        <CustomSwitch />
      </div>
      <Card
        rounded="lg"
        padding={6}
        className="absolute bg-white card-example max-w-xs sm:max-w-none top-80 left-2 sm:left-60"
      >
        ...
        <div className="flex items-center p-2 sm:p-6">
          <ProgressCircle
            classNamePercentage="w-full text-center text-grey-700 text-sm font-bold"
            value={80}
            width={56}
          >
            {null}
