...
const ComponentsSection = () => {
  ...
  return (
    <section className="m-auto section-components flex flex-col items-center mt-12 ">
      ...
      <Text
        size="4xl"
        className="font-bold text-blue-600 mb-7 px-9 text-center"
        variant="h1"
      >
      ...
      <section
        className="relative mb-6 section-goup-components hidden sm:block"
      ...
      >
        ...
        <div
          style={{ position: 'absolute', top: 81, left: 109 }}
          className="floating"
        >
          <Checkbox checked />
        </div>
        ...
        <div
          style={{ position: 'absolute', top: 291, left: 304 }}
          className="absolute floating"
        >
          <ProgressCircle
            classNamePercentage="w-full text-center text-blue-600 text-sm"
            value={30}
            width={50}
          >
            {' '}
        ...
        <div
          style={{ position: 'absolute', top: 174, left: 559 }}
          className="absolute floating"
        >
          <Circle
            width="36px"
      ...
      <div className="flex gap-6 px-10 flex-col sm:flex-row">
        <Link href="/docs/get-started/getting-started">
          <Button
            className="w-full sm:w-40 sm:max-w-[150px] h-10"
            paddingY="2"
            rounded="lg"
          >
            Get started
