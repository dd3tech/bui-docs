...
const CardExample = ({ style, className }: { style: StyleObject; className: string }) => (
    <Card padding={0} rounded="md" width={253} style={style} className={className}>
        ...
        <div className="flex pt-4 pr-6 pb-3 border-b border-gray-300">
            ...
            <span>
                ...
                <Anchor className="flex items-center text-blue-700">
                    <Text size="sm" className="pr-1 font-semibold underline" style={{ fontSize: 8 }}>
                        See more
                    </Text>
            ...
            <div className="pl-4 mt-5">
                <Circle className="border border-gray-400" style={{ width: 6.5, height: 6.5 }} />
            </div>
        </div>
