...
# <span name="floating-nav">Filter Select Multi</span>
...
The prop <span className='border border-gray-300 bg-gray-200 p-1'>initialItemList</span> it is used to show the available options, there is also the possibility of disabling one of them
<ContainerComponentDoc className="gap-y-2">
