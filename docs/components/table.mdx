...
With the prop <span className='border border-gray-300 bg-gray-200 p-1'>stickyTop</span> you can fix the header with a sticky position at the top
...
With the prop <span className='border border-gray-300 bg-gray-200 p-1'>stickyLeft</span> you can fix the header with a sticky position at the left
...
With the prop <span className='border border-gray-300 bg-gray-200 p-1'>colSpan</span> you can set the number of columns that the cell will occupy
...
With the prop <span className='border border-gray-300 bg-gray-200 p-1'>rowSpan</span> you can set the number of rows that the cell will occupy
...
You can use <span className='border border-gray-300 bg-gray-200 p-1'>Table.Accordion</span> for dropdown rows
