...
Go to <TagDocs text='pages/_app.js' /> or <TagDocs text='pages/_app.tsx' /> (create it if it doesn't exist) and add this:
...
To extend or override a token in the default theme, import the <TagDocs text='createTheme' /> function and add the keys you want to override. You can also add new values to the theme.
